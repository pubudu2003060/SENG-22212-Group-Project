...
function ProfileManagement() {
  const { userId, userContactNumber, firstName, lastName, address, idNo } =
    getSessionData();
  ...
  const validateOtp = async () => {
    try {
      const response = await fetch(
        "http://localhost:8080/api/v1/login/validate-otp",
        {
          method: "POST",
          headers: {
    ...
    return (
      <div className="otp-section">
        <div className="profile-form-group">
          ...
          <button className="otp-verify-btn" onClick={validateOtp}>
            Verify OTP
          </button>
          <button className="otp-resend-btn" onClick={requestOtp}>
            Resend OTP
          </button>
        </div>
      </div>
          ...
          <div className="ProfileInfo">
            ...
            <div className="profile-form-group">
              <label htmlFor="agreeTerms">
                I certify that the updated profile information provided is
            ...
            <div className="profile-footer-btn">
              ...
              <button id="profile-save-btn" onClick={handleSaveChanges}>
                Save Changes
              </button>
            </div>
          </div>
