...
function PersonalDetailsForm() {
    ...
    const sendOTP = () => {
        if(formData.phoneNumber.trim() != "" && formData.phoneNumber.length == 10 && /^07\d{8}$/.test(formData.phoneNumber)){
            axios
                .post(`https://pass-my-fule-backend.onrender.com/api/v1/login/send-otp/su/%2B94${formData.phoneNumber}`)
                .then((response) => {
    ...
    const verifyOTP = () => {
        axios
            .post("https://pass-my-fule-backend.onrender.com/api/v1/login/validate-otp", {
    ...
    const saveUserData = () => {
        ...
        axios
            .post("https://pass-my-fule-backend.onrender.com/api/v1/user/adduser", {
